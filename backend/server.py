    ...
    products = [
        {
            ...
            "stock": 50,
            "reorder_level": 10,
            "weighted_avg_cost": 1300.00,
            "last_purchase_price": 1300.00,
            "batches": [],
            "weight_based": False,
            "active": True,
            "created_at": datetime.utcnow().isoformat(),
        ...
        },
        {
            ...
            "stock": 30,
            "reorder_level": 5,
            "weight_based":"weighted_avg_cost": 0.00,
            "weight_based":"last_purchase_price": 0.00,
            "weight_based":"batches": [],
            "weight_based":"weight_based": False,
            "active": True,
            "created_at": datetime.utcnow().isoformat(),
            "updated_at": datetime.utcnow().isoformat()
        },
        ...
        },
        {
            ...
            "weight_based":"last_purchase_price": 0.00,
            "weight_based":"batches": [],
            "weight_based":"weight_based": True,
            "active": True,
            "created_at": datetime.utcnow().isoformat(),
            "updated_at": datetime.utcnow().isoformat()
        },
